...
You can get a checkpoint (`best_val_unseen`) and sample predictions (`submit_test_dynamic_ch2.json`) from [here](https://drive.google.com/drive/u/2/folders/1svrvFcpfLarWh-DO1hH4O8ZeYRRuoZ7t).
